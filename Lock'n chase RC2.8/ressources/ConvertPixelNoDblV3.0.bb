...
imageSource$ = "./Bios0_White_Reduce.bmp"
fileDest$ = "./global.txt"
pos = 0
...
For TileCouranteSource=0 To 767
	...
	;For d=0 To 255
		...
		If ldp0=lp0 And ldp1=lp1 And ldp2=lp2 And ldp3=lp3 And ldp4=lp4 And ldp5=lp5 And ldp6=lp6 And ldp7=lp7 And trouve=0 Then
			trouve=1
			switch = 0
		End If
	;Next
